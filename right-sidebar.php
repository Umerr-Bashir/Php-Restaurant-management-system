                ...
                <div class="widget-content">
                  ...
                  <div class="padd">
                             ...
                             <div class="support-contact">
                                ...
                                <p><i class="fa fa-phone"></i>&nbsp; Phone<strong>:</strong> 03134587952</p>
                                <hr />
                                <p><i class="fa fa-envelope"></i>&nbsp; Gmail<strong>:</strong> restaurantsystem@gmail.com</p>
                                <hr />
                                <p><i class="fa fa-home"></i>&nbsp; Address<strong>:</strong> johar Town, Lahore </p>
                <hr />
        <p><i class="fa fa-facebook"></i>&nbsp; Facebook<strong>:</strong> facebook.com/Restaurant System </p>
                <hr />              
                                <!-- Button -->
